...
c.Proxy.extra_routes = {
    "/hub/home": "https://first-jupyter.ikigailabs.io/hub/404",
    "/hub/token": "https://first-jupyter.ikigailabs.io/hub/404",
    "/hub/spawn-pending": "https://first-jupyter.ikigailabs.io/hub/404",
    "/user/ikigaiuser/lab": "https://first-jupyter.ikigailabs.io/hub/404",
    "/user/ikigaiuser/tree": "https://first-jupyter.ikigailabs.io/hub/404",
    "/user/ikigaiuser/lab?": "https://first-jupyter.ikigailabs.io/hub/404",
}
...
set_config_if_not_none(c.PassThroughAuthenticator, "guest_user", "hub.config.Authenticator.passthrough_user")
c.Authenticator.auto_login = True


# Enable admins to access user servers
set_config_if_not_none(c.Authenticator, "admin_users", "hub.config.Authenticator.admin_users")
set_config_if_not_none(c.Authenticator, "allowed_users", "hub.config.Authenticator.allowed_users")
set_config_if_not_none(c.Authenticator, "allowed_users", "auth.allowedUsers")
# set_config_if_not_none(c.PassThroughAuthenticator, "guest_user", "hub.config.JupyterHub.passthrough_user")
